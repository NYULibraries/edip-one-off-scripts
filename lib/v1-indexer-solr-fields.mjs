        ...
        xpath     : {
            ...
            unitdate_start     : {
                ...
                process      : 'For `unitdate_normal` fields, no extra processing' +
                               ...
                               ' `unitdate_end`: for each element returned, if' +
                               ' the value matches /(\\d{4})\\/(\\d{4})/, take' +
                               ' the number on the left of the slash for `unitdate_start`' +
                               ' and the number on the right of the slash for' +
                               ' `unitdate_end` and add to array to be indexed.',
                indexAsArray : [ FACETABLE, DISPLAYABLE, SORTABLE ],
            },
            unitid             : {
                xpath        : 'did/unitid',
